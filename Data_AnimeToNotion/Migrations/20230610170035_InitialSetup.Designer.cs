...
namespace Data_AnimeToNotion.Migrations
{
    ...
    [Migration("20230610170035_InitialSetup")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data_AnimeToNotion.DataModel.Note", b =>
                {
                    b.HasOne("Data_AnimeToNotion.DataModel.AnimeShow", "AnimeShow")
                        .WithOne("Note")
                        .HasForeignKey("Data_AnimeToNotion.DataModel.Note", "AnimeShowId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Data_AnimeToNotion.DataModel.Score", b =>
                {
                    b.HasOne("Data_AnimeToNotion.DataModel.AnimeShow", "AnimeShow")
                        .WithOne("Score")
                        .HasForeignKey("Data_AnimeToNotion.DataModel.Score", "AnimeShowId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Data_AnimeToNotion.DataModel.WatchingTime", b =>
                {
                    b.HasOne("Data_AnimeToNotion.DataModel.AnimeShow", "AnimeShow")
                        .WithOne("WatchingTime")
                        .HasForeignKey("Data_AnimeToNotion.DataModel.WatchingTime", "AnimeShowId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
